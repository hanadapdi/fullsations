...
const Message = () => {
  ...
  const { fuelprice , petrolquentity, Navtoquentity ,Gasquentity ,totalgasbuyment ,formattedDate} = useContext(fuelcontex)
      ...
      const pTotal = petrolquentity / petrolquentityforgas * 100;
      const nTotal = Navtoquentity / navtofuctionmap * 100;
      const gTotal = Gasquentity / Gasquentitys * 100;

  return (
    <div className='fixed right-16 top-16 w-[18%]'>
    
        <ul className='w-full py-3 bg-white mt-2 rounded text-sm font-press '>
        <div className='mx-3 font-semibold font-press'>Notivication</div>
            <li className='px-3 py-[6px] hover:bg-[#4aac9470] transition ease-linear mt-1 cursor-pointer'>
             <div className='flex justify-between font-press items-center'>
              <h1 className='font-semibold'>Petrol</h1> <h1>{pTotal}%</h1>
             </div>
            ...
            <li className='px-3 py-[6px] hover:bg-[#4aac9470] transition ease-linear mt-1 cursor-pointer'>
             <div className='flex justify-between font-press items-center'>
              <h1 className='font-semibold'>navato</h1> <h1>{nTotal}%</h1>
             </div>
             <div class="w-full bg-gray-200 rounded-full dark:bg-gray-700">
            ...
            <li className='px-3 py-[6px] hover:bg-[#4aac9470] transition ease-linear mt-1 cursor-pointer'>
             <div className='flex justify-between font-press items-center'>
              <h1 className='font-semibold'>Gas</h1> <h1>{gTotal}%</h1>
             </div>
             <div class="w-full bg-gray-200 rounded-full dark:bg-gray-700">
