...
export const AddbuymentUpdate = ({name ,price ,quantity}) =>{
  ...
  const saveprice = (e) =>{
    ...
    if(Category !== '' || Quantity !== '' || Price !== '' || Date !== '') {
        fetch('http://localhost:4000/fuelgas',{
         method:'post',
            headers:{
            ...
            <div className="relative w-[100%] my-6 mx-auto max-w-sm">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full darks bg-white outline-none focus:outline-none">
                ...
                <form className='w-full mt-1 text-black'>
                      ...
                      placeholder={price }
                      className='w-full p-3 darks border outline-none mt-6 rounded'/>
                      <br />
                      <input 
                      type="date"
                      onChange={Datechange}
