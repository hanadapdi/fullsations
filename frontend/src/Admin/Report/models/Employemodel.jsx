...
const Employemodel = () => {
  const {emplooyes , setemployees} = useContext(Modelcontex)
  ...
  return (
    ...
    <div className='flex  space-x-2 px-3 darks py-7  items-center rounded'>
            <div><FaUserAlt className='text-6xl text-[#4aac93]'/></div>
            <div className='w-full' onClick={()=>setemployees(true)}>
                <h1 className='font-press font-semibold text-[#4aac93]  darks'>Emplooye</h1>
                <p className='text-sm'>Total Emplooye</p>
