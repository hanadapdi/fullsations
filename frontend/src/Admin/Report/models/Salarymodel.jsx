...
import { FaFileInvoice, FaGasPump, FaUserAlt } from 'react-icons/fa'
...
const Salarymodel = () => {
  const {salary , setsalary} = useContext(Modelcontex)
  ...
  return (
    ...
    <div className='flex  space-x-2 px-3 darks py-7  items-center rounded'>
            <div><FaFileInvoice className='text-6xl text-[#4aac93]'/></div>
            <div className='w-full' onClick={() => setsalary(true)}>
                <h1 className='font-press font-semibold text-[#4aac93]  darks'>Salary hh</h1>
