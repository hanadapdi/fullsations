...
const CustomersellingGasfrom = () => {
  ...
  <     div>
    ...
    const buymentApi = () => {
       setShowModal(false) 
      fetch('http://localhost:4000/customerBuyments',{
        method:'post',
           headers:{
            "Content-Type" : "application/json"
           },
           body:JSON.stringify({
            customerCarId , customername , customerLocation , customerNumber , Quantity , category , price , dates
        })
      })
    }
                  ...
                  <div className="relative p-6 flex-auto">
                     <form className='w-full  text-black'>
                        ...
                        onChange={customerNamechnage}>
                           <option value="" >Enter Customer</option>
                           {customer.map((item , i) =>{
                            return(
                        ...
                        onChange={customerCarIdchange}>
                           <option value="" >Enter Car Id</option>
                           {customer.map((item , i) =>{
                            return(
...
export default CustomersellingGasfrom